...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>WikMeds | Landing, Corporate &amp; Business Templatee</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"><img class="d-inline-block me-3" src="assets/img/icons/logo.png" width="50" height="50" alt="" />WikMeds</a>
        ...
        <div class="container position-relative">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
              ...
              <p class="mt-3 mb-4 fs-1">WikMeds provides progressive, and affordable<br class="d-none d-lg-block" />healthcare, accessible on mobile and online<br class="d-none d-lg-block" />for everyone</p><a class="btn btn-lg btn-primary rounded-pill hover-top" href="/index" role="button">Pharmacy Data</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row g-xl-0 align-items-center">
            ...
            <div class="col-md-6 text-center text-md-start">
              ...
              <p class="pt-3">WikMeds provides progressive, and affordable healthcare, accessible on mobile and online for everyone. To us, it’s not just work. We take pride in the solutions we deliver</p>
              <div class="py-3">
                <button class="btn btn-lg btn-outline-primary rounded-pill" type="submit">Learn more </button>
              </div>
            </div>
      ...
      <section class="py-6 pt-7 bg-primary-gradient">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 order-0 order-sm-0 pe-6"><a class="text-decoration-none" href="#"><img class="img-fluid me-2" src="assets/img/icons/footer-logo.png" alt="" /><span class="fw-bold fs-1 text-light">WikMeds</span></a>
              <p class="mt-3 text-white">WikMeds provides progressive, and affordable healthcare, accessible on mobile and online for everyone</p>
            </div>
